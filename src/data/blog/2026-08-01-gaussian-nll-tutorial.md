...
$$
\mathcal{L} = \underbrace{\frac{1}{2\sigma_1^2}\mathrm{MSE}_1 + \frac{1}{2\sigma_2^2}\mathrm{MSE}_2}_{\text{被 σ 缩放的每任务 loss}} + \underbrace{\log\sigma_1 + \log\sigma_2}_{\text{防止 σ→∞}}
$$
